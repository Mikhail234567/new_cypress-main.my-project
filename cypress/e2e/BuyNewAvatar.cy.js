describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('Zabor123456@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('Veniamin95');               // вводим пароль
         ...
         cy.get('.card_number').type('2202208153604468');                     // вводим номер карты
         cy.get('.card_csv').type('125');                             // вводим CVV карты
         cy.get('.card_date').type('1030');                           // вводим срок действия карты
         cy.get('.card_name').type('MIKHAIL TSYGANOV');                           // вводим имя владельца действия карты
